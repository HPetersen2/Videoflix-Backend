        ...
        def enqueue_conversion():
            try:
                if instance.video_file and os.path.isfile(instance.video_file.path):
                    ...
                    raise FileNotFoundError(f"Die Videodatei existiert nicht: {instance.video_file.path}")
            except Exception as e:
                print(f"Fehler bei der Video-Konvertierung für {instance.id}: {e}")
...
def video_post_delete(sender, instance, **kwargs):
    ...
    try:
        ...
        print(f"Fehler beim Löschen von Dateien für Video {instance.id}: {e}")
